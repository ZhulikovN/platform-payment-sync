...
# poetry run pytest tests/test_find_contact/test_find_contact.py -v -s --log-cli-level=INFO
...
# def test_find_contact_by_custom_field() -> None:
...
#
#         contact = client.find_contact_by_custom_field("777888999000")
#
#         logger.info(f"\nРезультат поиска:")
#         if contact:
...
# @pytest.mark.integration
# def test_find_contact_by_phone() -> None:
...
#
#     try:
#         contact = client.find_contact_by_phone(NONEXISTENT_PHONE)
#
#         logger.info(f"\nРезультат поиска:")
#         if contact:
#             logger.info(f"  Контакт найден: ID={contact['id']}")
...
# @pytest.mark.integration
# def test_find_contact_by_email() -> None:
...
#
#     try:
#         contact = client.find_contact_by_email(NONEXISTENT_EMAIL)
#
#         logger.info(f"\nРезультат поиска:")
#         if contact:
#             logger.info(f"  Контакт найден: ID={contact['id']}")
...
# @pytest.mark.integration
# def test_find_contact_with_tg_id() -> None:
...
# @pytest.mark.integration
# def test_find_contact_with_phone_only() -> None:
...
# @pytest.mark.integration
# def test_find_contact_with_email_only() -> None:
...
# @pytest.mark.integration
# def test_find_active_lead() -> None:
...
#
#     try:
#         lead = client.find_active_lead(59596833, phone="+7 (922) 381-9660")
#
#         logger.info(f"\nРезультат поиска:")
#         if lead:
...
#             assert lead.get("closed_at") is None, "Сделка не должна быть закрытой"
#         else:
