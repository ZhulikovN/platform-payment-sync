...
def test_create_contact_and_lead_in_test_pipeline() -> None:
    ...
    try:
        ...
        # Шаг 2: НЕ вызываем find_active_lead() (контакт новый, сделок нет)
        ...
        # Шаг 3: Сразу создаем сделку в тестовой воронке
        ...
        # Шаг 5: Обновляем кастомные поля сделки
        ...
        # Шаг 6: Добавляем примечание (как в ТЗ)
...
Источник: integration_test"""
        ...
        # Шаг 7: Проверяем, что сделка создана в правильной воронке
